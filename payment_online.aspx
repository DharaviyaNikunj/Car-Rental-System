<%@ Page Language="C#" AutoEventWireup="true" CodeFile="payment_online.aspx.cs" Inherits="payment_online" %>
    ...
    <form id="Form1" class="row g-3" runat="server">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="txtcustomer_id" runat="server">
            <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="please enter a customure_id"></asp:CustomValidator>
        </div>
        <div class="col-md-6 ">
          ...
          <input type="text" class="form-control" id="txtpay_amount" runat="server">
            <asp:CustomValidator ID="CustomValidator5" runat="server" ErrorMessage="please enter a pay_amount"></asp:CustomValidator>
        </div>
           ...
           <div class="col-md-6 ">
            ...
            <asp:TextBox ID="txtonlinedate" runat="server" placeholder="From" type="date"></asp:TextBox>         
            <%--<input type="date" id="mainten_date" class="form-control" />--%>
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="please select a date" ControlToValidate="txtonlinedate" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="col-md-6 ">
          ...
          <input type="text" class="form-control" id="txtpay_method" runat="server">
            <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="please enter a licence_plate"></asp:CustomValidator>
        </div>
